...
const DEFAULT_RAPIDAPI_KEY = "5b7ed79f74mshd13a2741e84eb4fp1c36dejsn360c83caafcb";
const DEFAULT_RAPIDAPI_HOST = "youtube-mp37.p.rapidapi.com";
...
export async function getMp3FromRapidApi(videoUrlOrId: string): Promise<RapidApiMp3Result> {
  ...
  for (let attempt = 1; attempt <= 2; attempt++) {
    for (const host of hostCandidates) {
      // Prioritize /get?id= endpoint as requested by user python code
      const candidateUrls = [
